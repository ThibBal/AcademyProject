#!/bin/sh
# Script to build Open Academy 7.x-1.x
...
if [ $SELECTION = "1" ]; then
  ...
  echo "Building Open Academy distribution..."
  MAKEFILE='build-openacademy-release.make'
  DRUSH_OPTS='--no-cache'

elif [ $SELECTION = "2" ]; then

  echo "Building Open Academy distrbution..."
  MAKEFILE='build-openacademy-dev.make'
